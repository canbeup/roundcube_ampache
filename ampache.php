...
?>
			...
			<li id="amFLLast" class="mailbox" role="treeitem" aria-level="1"><a href="./?_task=ampache&amp;list=last" data-type="folder" data-path="music/gloony/" onclick="return false;">Last played</a></li>
			<li id="amFLRecent" class="mailbox" role="treeitem" aria-level="1"><a href="./?_task=ampache&amp;list=recent" data-type="folder" data-path="music/gloony/" onclick="return false;">Recently Added</a></li>
<?php
		}
		exit;
	}
